...
const NetworkDetailsCard = ({ status, statusLink, version, lastSporkDate, nextSporkDate, rssFeed }: NetworkDetailsCardProps) => {
  return (
    <div className="flex items-center text-center bg-white md:flex-row rounded-2xl dark:bg-gray-800 sm:flex-col" style={{ width: 'fit-content' }}>
      ...
      <div className="px-8 py-4">
        ...
        {/* @ts-ignore */}
        <Link href={rssFeed} className="flex items-center text-sm text-primary-blue dark:text-primary-gray-50">
