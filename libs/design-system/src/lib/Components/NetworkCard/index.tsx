...
const NetworkCard = ({
  ...
  return (
    <a
      href={link}
      className="flex items-center justify-around rounded-2xl bg-white px-4 py-6 hover:shadow-2xl dark:bg-primary-gray-dark xs:flex-col xs:text-center md:flex-row"
    >
