...
const FlipCell = ({
  ...
  return (
    <a
      href={forumLink}
      className="flex flex-col items-center justify-between p-6 bg-white rounded-lg dark:bg-primary-dark-gray hover:cursor-pointer hover:shadow-2xl md:flex-row md:p-8"
    >
