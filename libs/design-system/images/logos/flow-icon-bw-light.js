...
const SvgFlowIconBwLight = (props) => (
  <svg
    width={262}
    height={262}
    fill="none"
    ...
    {...props}
  >
    <circle cx={130.91} cy={130.91} r={130.91} fill="#fff" />
    <path fill="#000" d="M151.41 110.409h36.969v36.969H151.41z" />
    <path
      ...
      fill="#000"
    />
    <path d="M114.441 147.378h36.969v-36.969h-36.969v36.969Z" fill="#fff" />
  </svg>
) // for backwards-compat–

export const ReactComponent = SvgFlowIconBwLight
export default SvgFlowIconBwLight
