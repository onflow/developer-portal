  ...
  return (
    <footer className="bg-black px-6 text-white">
      <div className="container mx-auto">
        ...
        <div className="grid auto-cols-min gap-y-4 border-y border-y-primary-gray-400 px-2 pb-6 pt-9 xs:grid-cols-1 sm:grid-cols-2 sm:gap-x-12 md:grid-cols-[fit-content(33%)_fit-content(34%)_fit-content(33%)] md:gap-x-36 md:px-4">
